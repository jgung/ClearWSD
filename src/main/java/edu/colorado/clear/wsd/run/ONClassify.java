...
/**
 * OntoNotes sense groupings classification
 */
public class ONClassify
{
	protected String dataPath;
	protected String inputPath;
	protected String outputPath;
	protected boolean outputDep = false;
	public static final String outputExtension = "ws";
	private static final Logger LOG = LoggerFactory.getLogger(ONClassify.class);
	...
	public void classify(File inputFile, String outputName, ONClassifier classifier)
	{
		String input;
		try
		{
		...
		for (String sentence: sentences)
		{
			...
			} else
			{
				for (DEPNode node: tree)
				{
					if (!node.hasHead())
						continue;
					String sense = node.getFeat(DEPLib.FEAT_WS);
					if (sense == null) sense = "";
